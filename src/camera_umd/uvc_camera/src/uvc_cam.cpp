  ...
  width(_width), height(_height), fps(_fps), rgb_frame(NULL)
{
  ...
  try
  {
    ...
    set_control(10094851, 0);   // Exposure, Auto Priority(0)       HEX: 9a0903  DEC:10094851 ( 0 to 1 )
    set_control(10094849, 0);   // Exposure, Auto(0)                HEX: 9a0901  DEC:10094849 ( 0 to 2 )
    set_control(10094850, 300); // Exposure (Absolute)               HEX: 9a0902  DEC:10094850 ( 1 to 10000 )
    set_control(9963776, 128);  // Brightness                       HEX: 980900  DEC:9963776   (0 to 255)
    set_control(9963777, 32);   // Contrast                         HEX: 980901  DEC:9963777  (0 to 255)
    set_control(9963778, 32);   // Saturation */                    HEX: 980902  DEC:9963778  (0 to 255)
    set_control(9963795, 255);  // Gain                             HEX: 980913  DEC:9963795  (0 to 255)
    set_control(9963788, 1);    // White Balance Temperature, Auto  HEX: 98090c  DEC:9963788 ( 0 to 1  )
    set_control(9963800, 2);    // power line frequency to 60 hz    HEX: 980918  DEC:9963800 ( 0 to 2  )
    //set_control(9963802, 5984); // White Balance Temperature      HEX: 98091A  DEC:9963802 ( 0 to 10000 )
    set_control(9963803, 224);  // Sharpness                        HEX: 98091B  DEC:9963803 ( 0 to 255 )
    set_control(9963804, 1);    // Backlight Compensation           HEX: 98091C  DEC:9963804 ( 0 to 1 )
